...
public class Simulation {
    ...
    ArrayList<Item> loadItems(String pathname) throws Exception {
        ...
        System.out.println(pathname + " contains " + items.size() + " items");
        System.out.println();
    ...
    ArrayList<Rocket> loadU1(ArrayList<Item> list) {
        ...
        int itemCounter = 1;
        int rocketCounter = 1;
        System.out.println("U1 Rocket weight = " + r.weight + "; maxWeight = " + r.maxWeight);
